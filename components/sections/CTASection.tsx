...
export default function CTASection() {
  ...
  return (
    <section ref={ref} style={{ background: "#0A0807", padding: "6rem 0 10rem", overflow: "hidden" }}>
      <motion.div style={{ scale, opacity, maxWidth: 1280, margin: "0 auto", padding: "0 3rem" }}>
        {/* Big cinematic CTA panel */}
        <div style={{ position: "relative", background: "#2A1C10", padding: "clamp(4rem,10vw,8rem) clamp(2rem,8vw,7rem)", overflow: "hidden" }}>
          {/* Corner details */}
          ...
          <div style={{ position: "relative", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 32 }}>
            <FadeIn><p style={{ fontFamily: "Inter, sans-serif", fontSize: "0.65rem", letterSpacing: "0.38em", textTransform: "uppercase", color: "#C9853E" }}>Let's Build Together</p></FadeIn>

            <TextReveal tag="h2" style={{ fontFamily: '"Space Grotesk", sans-serif', fontSize: "clamp(2rem,4.5vw,3.6rem)", fontWeight:500, color: "#EDE6D6", maxWidth: 700 }}>
              Have a project? We're ready to listen.
            </TextReveal>

            <FadeIn delay={0.2}>
              <p style={{ fontFamily: "Inter, sans-serif", fontSize: "0.82rem", color: "rgba(237,230,214,0.45)", lineHeight: 1.85, maxWidth: 420, textAlign: "center" }}>
            ...
            <FadeIn delay={0.35} style={{ display: "flex", gap: 20, flexWrap: "wrap", justifyContent: "center" }}>
              <a href="/contact" style={{ fontFamily: "Inter, sans-serif", fontSize: "0.68rem", letterSpacing: "0.35em", textTransform: "uppercase", padding: "14px 36px", background: "#C9853E", color: "#EDE6D6", textDecoration: "none", transition: "all 0.35s" }}
              ...
              <a href="/services" style={{ fontFamily: "Inter, sans-serif", fontSize: "0.68rem", letterSpacing: "0.35em", textTransform: "uppercase", padding: "14px 36px", border: "1px solid rgba(201,133,62,0.5)", color: "rgba(237,230,214,0.7)", textDecoration: "none", transition: "all 0.3s" }}
                onMouseEnter={e => { e.currentTarget.style.borderColor="#C9853E"; e.currentTarget.style.color="#EDE6D6"; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor="rgba(201,133,62,0.5)"; e.currentTarget.style.color="rgba(237,230,214,0.7)"; }}>
                View Services
              </a>
            </FadeIn>
          </div>
